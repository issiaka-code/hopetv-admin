                ...
                <div class="modal-body">
                    ...
                    <div id="editAudioFileSection" class="d-none">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="image_couverture_audio" id="editAudioImageFile" class="custom-file-input @error('image_couverture_audio') is-invalid @enderror" accept="image/*">
                    ...
                    <div id="editVideoLinkSection" class="d-none">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="image_couverture_link" id="editlinkImageFile" class="custom-file-input @error('image_couverture_link') is-invalid @enderror" accept="image/*">
                                <label class="custom-file-label" for="editlinkImageFile">Choisir une image</label>
                                @error('image_couverture_link')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <small class="form-text text-muted">Formats acceptés: JPG, PNG, GIF (max 2MB)</small>
                            <div id="editfileCurrentLink" class="mt-2">
                                <small>image actuel: <span id="editfileCurrentLinkValue"></span></small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="editPdfFileSection" class="d-none">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="fichier_pdf" id="editPdfFile" class="custom-file-input @error('fichier_pdf') is-invalid @enderror" accept=".pdf">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Image de couverture</label>
                            <div class="custom-file">
                                <input type="file" name="image_couverture_pdf" id="editPdfImageFile" class="custom-file-input @error('image_couverture_pdf') is-invalid @enderror" accept="image/*">
