<div class="modal fade" id="addTemoignageModal" tabindex="-1" role="dialog" aria-labelledby="addTemoignageModalLabel" aria-hidden="true">
            ...
            <form id="addTemoignageForm" method="POST" action="{{ route('temoignages.store') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nom" id="addTemoignageNom" class="form-control @error('nom') is-invalid @enderror" required>
                        @error('nom')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="addTemoignageDescription" class="form-control @error('description') is-invalid @enderror" rows="3" required></textarea>
                        @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div id="addAudioFileSection">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="image_couverture_audio" id="addAudioImageFile" class="custom-file-input @error('image_couverture_audio') is-invalid @enderror" accept="image/*">
                    ...
                    <div id="addVideoFileSection" class="d-none">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="fichier_video" id="addVideoFile" class="custom-file-input @error('fichier_video') is-invalid @enderror" accept="video/*">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Image de couverture <span class="text-danger">*</span></label>
                            <div class="custom-file">
                                <input type="file" name="image_couverture_video" id="addVideoImageFile" class="custom-file-input @error('image_couverture_video') is-invalid @enderror" accept="image/*">
                    ...
                    <div id="addVideoLinkSection" class="d-none">
                        <div class="form-group">
                            ...
                            <input type="url" name="lien_video" id="addVideoLink" class="form-control @error('lien_video') is-invalid @enderror" placeholder="https://www.youtube.com/watch?v=..." pattern="https?://.+" title="Veuillez entrer une URL valide commençant par http:// ou https://">
                            @error('lien_video')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Image de couverture <span class="text-danger">*</span></label>
                            <div class="custom-file">
                                <input type="file" name="image_couverture_link" id="addlinkImageFile" class="custom-file-input @error('image_couverture_link') is-invalid @enderror" accept="image/*">
                                <label class="custom-file-label" for="addlinkImageFile">Choisir une image</label>
                                @error('image_couverture_link')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <small class="form-text text-muted">Formats acceptés: JPG, PNG, GIF (max 2MB)</small>
                    ...
                    <div id="addPdfFileSection" class="d-none">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="fichier_pdf" id="addPdfFile" class="custom-file-input @error('fichier_pdf') is-invalid @enderror" accept=".pdf">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Image de couverture <span class="text-danger">*</span></label>
                            <div class="custom-file">
                                <input type="file" name="image_couverture_pdf" id="addPdfImageFile" class="custom-file-input @error('image_couverture_pdf') is-invalid @enderror" accept="image/*">
                    ...
                    <div id="addImageFileSection" class="d-none">
                        <div class="form-group">
                            <label class="font-weight-bold">Images (plusieurs) <span class="text-danger">*</span></label>
                            <div class="custom-file">
                                <input type="file" name="images[]" id="addImageFiles" class="custom-file-input" multiple accept="image/*" required>
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Image de couverture <span class="text-danger">*</span></label>
                            <div class="custom-file">
                                <input type="file" name="image_couverture_images" id="addImageCoverFile" class="custom-file-input" accept="image/*" required>
