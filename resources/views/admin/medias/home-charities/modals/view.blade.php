<!-- Modal pour visualiser la charité -->
<div class="modal fade" id="homeCharityViewModal" tabindex="-1" role="dialog" aria-labelledby="homeCharityViewModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-static" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title mb-2" id="homeCharityViewModalLabel">Charité</h5>
            ...
            <div class="modal-body">
                ...
                <div id="audioPlayerContainer" class="text-center overflow-hidden mb-4 d-none">
                    ...
                    <audio id="modalAudioPlayer" controls autoplay class="w-100 custom-audio-player">
                ...
                <div id="videoPlayerContainer" class="text-center overflow-hidden mb-4 d-none">
                    <video id="modalVideoPlayer" controls autoplay class="w-100" style="max-height: 400px;">
                ...
                <div class="mt-2 text-justify">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p id="homeCharityDescription" class="text-muted mb-0"></p>
                        </div>
                    </div>
                </div>
            </div>
