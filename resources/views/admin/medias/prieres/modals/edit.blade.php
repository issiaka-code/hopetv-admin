<!-- Modal pour ÉDITER une prière -->
<div class="modal fade" id="editPriereModal" tabindex="-1" role="dialog" aria-labelledby="editPriereModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-static" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info text-dark">
                <h5 class="modal-title" id="editPriereModalLabel">Modifier la prière</h5>
                <button type="button" class="close text-dark" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="editPriereForm" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="form-group">
                        <label class="font-weight-bold">Nom <span class="text-danger">*</span></label>
                        <input type="text" name="nom" id="editPriereNom"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="editPriereDescription"
                    ...
                    <div id="editVideoFileSection" class="d-none">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Image de couverture</label>
                            <div class="custom-file">
                                <input type="file" name="image_couverture_video" id="editPriereThumbnail"
                                    class="custom-file-input @error('image_couverture_video') is-invalid @enderror"
                                    accept="image/*">
                                <label class="custom-file-label" for="editPriereThumbnail">Choisir une nouvelle image</label>
