                    ...
                    <div class="modal-body">
                        ...
                        <div id="addAudioFileSection">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="image_couverture" id="addPodcastAudioThumbnail"
                                        class="custom-file-input @error('image_couverture') is-invalid @enderror"
                                        accept="image/*">
                                    <label class="custom-file-label" for="addPodcastAudioThumbnail">Choisir une image</label>
                        ...
                        <div id="addVideoFileSection" class="d-none">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="image_couverture" id="addPodcastThumbnail"
                                        class="custom-file-input @error('image_couverture') is-invalid @enderror"
                                        accept="image/*">
                                    <label class="custom-file-label" for="addPodcastThumbnail">Choisir une image</label>
                                    @error('image_couverture')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
