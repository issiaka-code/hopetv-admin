<!-- Modal pour ÉDITER un enseignement -->
<div class="modal fade" id="editEnseignementModal" tabindex="-1" role="dialog" aria-labelledby="editEnseignementModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-static" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info text-dark">
                <h5 class="modal-title" id="editEnseignementModalLabel">Modifier l'enseignement</h5>
                <button type="button" class="close text-dark" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="editEnseignementForm" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="form-group">
                        <label class="font-weight-bold">Nom <span class="text-danger">*</span></label>
                        <input type="text" name="nom" id="editEnseignementNom"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="editEnseignementDescription"
                    ...
                    <div id="editVideoFileSection" class="d-none">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Image de couverture</label>
                            <div class="custom-file">
                                <input type="file" name="image_couverture_video" id="editEnseignementThumbnail"
                                    class="custom-file-input @error('image_couverture_video') is-invalid @enderror"
                                    accept="image/*">
                                <label class="custom-file-label" for="editEnseignementThumbnail">Choisir une nouvelle image</label>
