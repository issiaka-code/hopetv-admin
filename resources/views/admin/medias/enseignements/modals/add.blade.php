<div class="modal fade" id="addEnseignementModal" tabindex="-1" role="dialog" aria-labelledby="addEnseignementModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-static" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="addEnseignementModalLabel">Ajouter un enseignement</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="addEnseignementForm" method="POST" action="{{ route('enseignements.store') }}"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label class="font-weight-bold">Nom <span class="text-danger">*</span></label>
                        <input type="text" name="nom" id="addEnseignementNom"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="addEnseignementDescription"
