                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                            ...
                            <label class="btn btn-outline-primary" id="editMediaTypeVideoLabel">
                                <input type="radio" name="media_type" id="editMediaTypeVideo" value="video" autocomplete="off">
                                <i class="fas fa-video"></i> Fichier vidéo
                            </label>
                            <label class="btn btn-outline-primary" id="editMediaTypeLinkLabel">
                                <input type="radio" name="media_type" id="editMediaTypeLink" value="link" autocomplete="off">
