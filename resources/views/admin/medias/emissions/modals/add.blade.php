<div class="modal fade" id="addEmissionModal" tabindex="-1" role="dialog" aria-labelledby="addEmissionModalLabel"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-static" role="document">
        <div class="modal-content">
            ...
            <form id="addEmissionForm" method="POST" action="{{ route('emissions.store') }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                            ...
                            <label class="btn btn-outline-primary" id="addMediaTypeLinkLabel">
                                <input type="radio" name="media_type" id="addMediaTypeLink" value="link"
                                    autocomplete="off">
                    ...
                    <div id="addVideoFileSection" class="d-none">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="image_couverture_video" id="addEmissionThumbnail"
                                    class="custom-file-input @error('image_couverture_video') is-invalid @enderror"
                                    accept="image/*">
                                <label class="custom-file-label" for="addEmissionThumbnail">Choisir une image</label>
